...
Reusable Nix functions extending nixpkgs.lib for godtamnix-specific patterns.
...
nix repl
> :lf .
> lib.godtamnix.myCategory.myFunction "a" "b"
"ab"
```
...
nix repl
> :lf .
> lib.godtamnix.file.getFile "modules"
/nix/store/.../modules

# Test via build
nix eval .#lib.godtamnix.file.scanDir ./lib
